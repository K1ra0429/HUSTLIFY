...
('business', 'Бизнес под ключ',
  ...
  3490, 14900, '/src/assets/case-business.png', 'none', '', NULL, false, 1),
('standard', 'Стандарт',
  ...
  2589, 3100, '/src/assets/case-pencil.jpg', 'none', '', NULL, false, 2),
('extended', 'Расширенный',
  ...
  3289, 4000, '/src/assets/case-palette.jpg', 'hit', 'Хит продаж', NULL, false, 3),
('premium', 'Премиум',
  ...
  4289, 5500, '/src/assets/case-organizer.jpg', 'none', '', NULL, false, 4);
